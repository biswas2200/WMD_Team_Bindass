...
const ReferenceCard = ({ data, isOpen, toggle }) => {
  return (
    <div
      className={`ka-card ${isOpen ? "active" : ""}`}
      style={{ marginBottom: "1.5rem", transition: "all 0.3s ease" }}
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            <h3 className="ka-text-xl ka-font-bold" style={{ margin: 0 }}>
              {data.title}
            </h3>
            <p
              className="ka-text-sm ka-text-muted"
      ...
      {isOpen && (
        <div
          className="ka-card-body ka-slide-up"
        ...
        >
          ...
          >
            ...
            <div
              className="ka-card"
              style={{ background: "var(--ka-primary-50)", border: "none" }}
            >
              <div className="ka-card-body">
                <h4
                  className="ka-text-lg ka-font-bold"
                  style={{
                    marginBottom: "1rem",
                    display: "flex",
                    alignItems: "center",
            ...
            <div
              className="ka-card"
              style={{ background: "var(--ka-secondary-50)", border: "none" }}
            >
              <div className="ka-card-body">
                <h4
                  className="ka-text-lg ka-font-bold"
...
export default function References() {
  ...
  return (
    <div
      className="ka-container ka-fade-in"
      style={{ paddingBottom: "4rem", paddingTop: "2rem" }}
    >
      <div className="ka-text-center" style={{ marginBottom: "3rem" }}>
        <h1
          className="ka-text-4xl ka-font-extrabold"
          style={{
            background:
              "linear-gradient(135deg, var(--ka-primary-600), var(--ka-secondary-500))",
